package com.bawei.asus.dandian;
 ...
 */
public class DanDian extends View {
    /**
     * 图片的最大缩放比例
     */
    ...
    public DanDian(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DanDian(Context context) {
        this(context, null);
    }

    public DanDian(Context context, AttributeSet attrs, int defStyle) {
